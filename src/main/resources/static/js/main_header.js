...
function joinValidate(){
    ...
    if(joinForm.memberId.value == ''){
        inputInvalidate('#id-error-div', 'ID는 필수입력입니다.');
        return ;
    }
    ...
    //telRegex.test('010-1111-2222'); // true
    //telRegex.test('010-111-2222'); // false
    ...
    if(!telRegex.test(tel)){
        inputInvalidate('#tel-error-div', '연락처가 잘못 입력 됐어요.');
        return ;
    }
